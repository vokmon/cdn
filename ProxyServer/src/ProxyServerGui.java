...
public class ProxyServerGui implements ProxyServerListener {
	...
	@Override
	public void responseFromCache(final String fileName) {
		SwingUtilities.invokeLater(new Runnable() {
		    public void run() {
		      String message = String.format("response: cached file %s", fileName);
		      textArea.append(message+"\n");
		      logger.info(message);
		    }
		  });
	...
	@Override
	public void responseFromServer(final String fileName) {
		SwingUtilities.invokeLater(new Runnable() {
		    public void run() {
		      String message = String.format("response: file %s downloaded from the server", fileName);
		      textArea.append(message+"\n");
		      logger.info(message);
		    }
		  });
